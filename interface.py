...
def instructions():
	...
	print('  "restart"           Starts a new game and saves your current one')
	...
	print('      console-bell    Beep after AI generates text? Default: on | Current:',settings.getboolean("console-bell"))
