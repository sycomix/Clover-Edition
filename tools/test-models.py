...
print('\x1B[36m',end='')
print(
    f"This should print 2 identical lines if the models are identical. From the starting prompt of {prompt}"
)
...
print(
    f"They are both using the same random seed, {seed}, the same temperature={temp} and top_p={top_p}"
)
